...
class RDT:
        ...
        while True:
            ...
            if acknowledge:
                ...
                if pkt_rcv is None:
                    ...
                    continue
                elif Packet_2_1.corrupt(pkt_rcv):
                    #print("receive corrupt packet")
                    continue
                elif Packet_2_1.isACK(pkt_rcv):
                    #print("receive ACK")
                    break
                else:
                    #print("receive NAK")
    ...
    def rdt_2_1_receive(self):
        ...
        while True:
            ...
            if p is None or p.ACK == 1 or p.NAK == 1:
                #self.byte_buffer.remove(byte_S)
                msg_ACK = False
                self.rdt_2_1_send(msg_ACK)
                #print("send NAK")
                return None
